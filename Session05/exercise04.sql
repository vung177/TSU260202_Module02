...
CREATE TABLE order_items (
    ...
    customer_id INT, -- khai bao theo dung cot trong yeu cau de bai
...
(1, 1, 'Laptop Dell', 1, 15000000.00),
(2, 2, 'iPhone 13', 1, 14000000.00),
(2, 2, 'Phone Case', 2, 2000000.00), -- Tong don 2 = 18.000.000
...
SELECT o.order_id, oi.product_name, oi.quantity, oi.price 
FROM orders o
