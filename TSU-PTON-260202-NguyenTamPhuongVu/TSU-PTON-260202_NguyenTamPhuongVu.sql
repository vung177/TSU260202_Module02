...
INSERT INTO Trains (train_id, train_name, train_type, total_seats) VALUE ('T001', 'Tau Thong Nhat 1', 'SE', 500),
...
INSERT INTO Tickets (
        ...
        seat_number,
        ticket_price
    ) VALUE ('TK001', 'P001', 'T001', '2025-06-10', 'A01', 850000),
...
SELECT t.train_id,
    t.train_name,
    COUNT(ts.ticket_id) AS p_amount
FROM Trains AS t
