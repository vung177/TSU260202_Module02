...
INSERT INTO employees (full_name, birth_year, department, salary, phone, emp_email) VALUES
('Nguyen Hoang Anh', 1995, 'IT', 15000000.00, '0912345678', 'anguyen@example.com'), -- Tên chứa 'Anh'
('Tran Thi B', 1998, 'HR', 12000000.00, '0987654321', 'btran@example.com'),
('Le Tuan Anh', 1990, 'Sales', 9500000.00, '0901234567', 'clevan@example.com'), -- Tên chứa 'Anh'
('Pham Minh D', 1993, 'IT', 22000000.00, '0934567890', 'dpham@example.com'),
('Hoang Lan E', 1997, 'Marketing', 11000000.00, NULL, 'ehoang@example.com'), -- Điện thoại NULL
('Vu Hoang F', 1992, 'HR', 18000000.00, '0945678901', 'fvu@example.com'),
('Do Thi G', 1996, 'IT', 10000000.00, '0956789012', 'gdo@example.com'),
('Ngo Van H', 1989, 'Accounting', 14000000.00, NULL, 'hngo@example.com'), -- Điện thoại NULL
('Bui Thi I', 1994, 'IT', 25000000.00, '0978901234', 'ibui@example.com'),
('Ly Van J', 2000, 'HR', 4500000.00, '0989012345', 'jly@example.com'); -- Lương dưới 5M để test DELETE
